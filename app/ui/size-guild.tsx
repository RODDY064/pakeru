          ...
          >
            ...
            <div className="py-12 px-6 md:px-16 overflow-scroll h-full">
              ...
              <div className="mt-10 w-full min-h-24 border rounded-md border-black/10">
                ...
                <div className="grid max-sm:grid-cols-1 grid-cols-5 ">
                  {currentMeasurements.map(({ label, value }) => (
                    <div key={label} className="py-2 md:py-4">
                      ...
                      <p className="mt-6 px-4 font-avenir text-sm">{value}</p>
                       {label !== "HIPS"  && <div className="w-full h-[1px] bg-black/10 my-2 md:hidden" />
                ...
                <div className="mt-4 mb-20">
                  <div>
                    ...
                    <p className="my-3 text-md font-avenir font-[500] text-black/70">
                      Pass the tape measure straight across from the tip of one
                      shoulder to the other, just above your shoulder blades
                    </p>
                  </div>
                  <div className="mt-10">
                    <p className="font-avenir font-[500] text-lg">2. Chest</p>
                    <p className="my-3 text-md font-avenir font-[500] text-black/70">
                      Pass the tape measure across your back, under your arms
                      and over your breastbone at its widest point, taking care
                      to keep the tape measure horizontal. It should sit snugly
                      against your body, but should not be pulled too tight
                    </p>
                  </div>
                  <div className="mt-10">
                    <p className="font-avenir font-[500] text-lg">3. Waist</p>
                    <p className="my-3 text-md font-avenir font-[500] text-black/70">
                      Pass the tape measure around your natural waistline, at
                  ...
                  <div className="mt-10">
                    ...
                    <p className="my-3 text-md font-avenir font-[500] text-black/70">
                      Keeping your arm straight by your side, measure from the
                      tip of your shoulder to the base of your thumb
                    </p>
                  </div>
                </div>
              </div>
