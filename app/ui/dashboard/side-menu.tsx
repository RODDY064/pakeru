        ...
        {pages.map((item) => (
          ...
          <div
            ...
            className={cn(
              ...
              { "bg-white/60  hover:bg-bg-white/60 border-black/20  hover:border-black/20 ": pathname.includes(item.path) }
            )}>
             <Image
                src={`/icons/${item.icon}`}
                width={item.imgW?? 16}
        ...
        <p className="font-avenir font-[500] text-sm text-black/30 ml-3">Manage Store</p>
           <div
            className={cn(
              ...
              { "bg-white/60  hover:bg-bg-white/60 border-black/20  hover:border-black/20 ": pathname === '/contents' }
            )}>
