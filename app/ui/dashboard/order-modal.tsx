...
export default function OrderModal({
  ...
  useEffect(()=>{
    console.log(orderInView, 'order in vieew')
  },[orderInView])
                    ...
                    <div className="h-full overflow-scroll pb-24">
                      <div className="px-10 py-6 ">
                        ...
                        <div className="mt-4">
                          ...
                          <p className="font-avenir font-[500] cursor-pointer text-blue-600 decoration-dotted underline underline-offset-2  text-md decorated-dotted">
                        ...
                        <div className="mt-6 w-full flex flex-col gap-2">
                          ...
                          {orderInView?.fulfilledStatus === "unfulfilled" && (
                            <button
                              ...
                              disabled={isUpdating}
                              className="px-4 my-4 py-3 text-xl text-center bg-black text-white font-avenir font-[500] text-md rounded-md cursor-pointer hover:opacity-80 disabled:opacity-50 disabled:cursor-not-allowed"
                            >
