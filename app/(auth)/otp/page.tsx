  ...
  return (
    <div className="flex flex-col items-center pt-16 md:pt-24">
      ...
      <p className="font-manrop text-md md:text-lg font-medium my-4 text-center">
        ...
        <span className="font-semibold"> ac*******@gmail.com</span>
      </p>
      ...
      >
        ...
        <button
          ...
          className={`
            w-full h-11 mt-10 rounded font-manrop font-semibold text-md
            transition-all duration-200 border
            ${isOtpComplete && !isSubmitting
              ? 'bg-black text-white hover:bg-transparent hover:border-black hover:text-black cursor-pointer'
