...
export default function SingleProduct() {
  ...
  const { isMobile, products } = useBoundStore();
  ...
  return (
    <div className="w-full min-h-screen  flex flex-col items-center text-black bg-white home-main pt-24  transition-all">
        ...
        >
          <div className="w-full px-6 md:px-8 md:w-[90%] lg:w-[80%] xl:w-[60%]">
            ...
            <div className="my-4">
              ...
              <p className="my-4 text-black/60">
                Thirst for knowledge, tremendous curiosity for life and wealthy
                of experience is the essential instrumental tools for a good
                copy writing.
              </p>
            </div>
            <div className="my-4 mt-10 md:mt-6">
              <div className="flex items-center gap-2">
                ...
                <div className="text-sm font-avenir font-[400] text-black/50 flex items-center gap-2 ml-4">
                  <div className="w-12 h-[1px] bg-black/30"></div>WHITE
                </div>
              </div>
              ...
              <div className="mt-10 rounded py-2.5 flex items-center justify-center gap-3 w-full  bg-black  hover:bg-green-500 hover:border-green-500 border border-black/20  group/add cursor-pointer transition-all">
      ...
      <div className="w-full mt-10 md:my-24 ">
        ...
        <div className="mt-4">
          <div className="w-full flex ">
            <div
              className="flex gap-4 overflow-x-scroll overflow-hidden nav-slider px-4 md:px-8">
