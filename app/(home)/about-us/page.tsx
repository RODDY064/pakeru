  ...
  return (
    <div className="w-full min-h-dvh px-4 pt-[35%] sm:pt-[25%] md:pt-32 xl:pt-42 flex xl:items-center justify-center mb-24">
      <div className="w-[95%] md:w-[70%] lg:w-[60%] min-h-[400px]">
        ...
        {/* ✅ Add this new paragraph for Google verification */}
        <p className="text-justify md:text-pretty text-md md:text-2xl font-avenir mt-6 text-black/60">
          <strong>Pakeru</strong> is a modern streetwear and lifestyle platform built to connect
          art, fashion, and culture through digital craftsmanship. Our web app
          allows users to explore collections, make purchases, and manage orders
          in a secure, seamless experience. We use Google Sign-In to simplify
          authentication and protect your account, accessing only basic profile
          information (name and email) to personalize your shopping experience.
          <br />
          Learn more in our{" "}
          <Link
            href="/policy"
            className="underline text-blue-600 decoration-dotted underline-offset-2"
          >
            Privacy Policy
          </Link>{" "}
          and{" "}
        ...
        {/* Existing poetic brand story */}
        <p className="text-justify md:text-pretty text-md md:text-2xl font-avenir mt-8 indent-8 text-black/50">
        ...
        <p className="text-justify md:text-pretty text-md md:text-2xl font-avenir mt-4 text-black/50">
          They are symbols of identity, rewards for those who have escaped the
          ordinary, and challenges for those still breaking free. Minimal yet
          bold, tailored yet expressive, each garment is designed to move with
          you, to become part of your story. At Pakeru, we do not chase trends.
          We honor craft, rarity, and defiance. This is not just our story—it is
          yours. A legacy carried in fabric, stitched for those who dare to
          stand apart."
        </p>
        ...
        <div className="mt-12 flex flex-col items-center">
          <div className="w-[98%] md:w-[80%] lg:w-[60%] h-[200px] md:h-[250px] bg-[#f2f2f2] rounded-2xl p-[2px] overflow-hidden relative flex items-center justify-center">
            ...
            <div className="w-full h-full rounded-2xl p-4 md:p-8 relative top-0">
              ...
              <p className="font-avenir text-black mt-3 text-lg">KNUST.</p>
