...
export default function Contents() {
  const { toggleContentModal, galleries, hero, sliders } = useBoundStore();
                ...
                {galleries[0]?._id && (
                  <>
                    <div
                      ...
                      className="w-full flex-nowrap cursor-pointer flex-none h-[350px] bg-black/5 flex border border-dashed border-black/30  items-center justify-center relative rounded-[36px]"
                    >
                      <div className="flex flex-col items-center gap-4">
